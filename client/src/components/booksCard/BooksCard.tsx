    ...
    return (
        <div className="container mx-auto">
            <div className="flex  justify-between align-middle" >
                <p className="bookscard mb-3 text-[24px] translate-y-1">All books</p>
                    ...
                    <Card className=" w-[210px] " key={index}>
                        <CardHeader className="p-1">
                            ...
                            <CardDescription>
                                ...
                                <div>
                                    <p className="my-1">The story of Harry Potter and <br /> the wizarding world will live forever</p>
                                </div>
