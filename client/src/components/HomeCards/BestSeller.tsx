  ...
  return (
    <div className="px-12 mx-auto">
      <div className="flex justify-between align-middle mb-4">
        <p className="booksline mb-3 text-[24px] translate-y-1">Best seller</p>
        <div
          className="flex justify-center align-middle text-sky-600 text-center mb-3 translate-y-3"
          ...
          <Card className="" key={index}>
            <CardHeader className="p-1">
              ...
              <CardDescription>
                ...
                <div>
                  <p className="my-1">
                    The new science fiction and <br />
