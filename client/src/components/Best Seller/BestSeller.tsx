    ...
    return (
        <div className="container mx-auto">
            <div className="flex  justify-between align-middle" >
                <p className="bookscard mb-3 text-[24px] translate-y-1">Best seller</p>
                ...
                {Array.from({ length: 6 }, (_, index) => (
                    <Card className=" w-[210px] " key={index}>
                        <CardHeader className="p-1">
                            ...
                            <CardDescription>
                                <div className="flex justify-between align-middle">
                                    <p className=" text-black font-bold text-lg my-1">Summer sons</p>
                                    <svg
                                        viewBox="0 0 1024 1024"
                                        fill="currentColor"
                                        height="2em"
                                        ...
                                        className="text-orange-600 translate-y-1">
                                ...
                                <div>
                                    <p className="my-1">The new science fiction and <br />fantasy books to read this summer</p>
                                </div>
                                ...
                                <div >
                                    <p className="text-black font-bold text-lg my-1">$9.90</p>
