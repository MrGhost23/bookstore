        ...
        <>
            <div className="container mx-auto">
                ...
                <div className='flex justify-center align-middle'>
                    ...
                    <Card className=" w-99 border-none shadow-none my-10">
                        <CardContent className='flex justify-cemter align-middle'>
                            ...
                            <div>
                                <p className="bookName">Summer sons</p>
                    ...
                    <Card className="w-72 h-60 my-10">
                        <CardContent className='mt-5'>
                            ...
                            <div className="flex items-center">
                                ...
                                <button className="w-10 mx-0 ">
                                    <svg className="w-4 h-4 -translate-x-2 translate-y-0" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <button className="w-10">
                                    <svg className="w-4 h-4 -translate-x-2 translate-y-0" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M10 4a1 1 0 0 1 1 1v4h4a1 1 0 1 1 0 2h-4v4a1 1 0 1 1-2 0v-4H6a1 1 0 1 1 0-2h4V5a1 1 0 0 1 1-1z" />
                                    </svg>
                                </button>
                            </div>

                            <button type="button">Add to basket</button>
                            <button className='buybtn border border-gray-400 mt-1'>Buy</button>
                        </CardContent>
                    </Card>
